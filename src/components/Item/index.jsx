...
class Item extends Component {
  render() {
    const item = {
      ...
      priceSpecs: "piece",
      priceGiven: false,
      priceStatement: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam optio laudantium odit! Veritatis, at enim."
    };
    return (
      <div className="my-md-3 mt-lg-0 mr-3 zIndex-1">
        <ItemTable {...item}/>
        <div className="mt-5 mb-3 px-3">
            <h4>Disclaimer</h4>
            <div>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                Itaque molestiae cumque magnam accusamus ipsa dolores minima quod rem, 
                voluptatum rerum eveniet fugit deleniti consequuntur placeat 
                labore quo, eos sapiente provident consectetur delectus, sed illo dolorum corrupti? 
                Ad voluptates atque omnis.
            </div>
        </div>
      </div>
    );
